...
/* harmony import */ var _fetchers_getToken__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./fetchers/getToken */ "./scripts/fetchers/getToken.js");
/* harmony import */ var _fetchers_getUserNickname__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./fetchers/getUserNickname */ "./scripts/fetchers/getUserNickname.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.getElementById('extension-login-button').addEventListener('click', function () {
    ...
    chrome.identity.launchWebAuthFlow({
      ...
      var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(redirectUrl) {
        var params, code, token, nickname;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
            ...
            case 3:
              ...
              _context.next = 7;
              return (0,_fetchers_getToken__WEBPACK_IMPORTED_MODULE_1__.getToken)(code, redirectUri);
            case 7:
              token = _context.sent;
              chrome.storage.local.set({
                githubToken: token
